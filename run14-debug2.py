...
early_callback = EarlyStopping(monitor='val_loss', min_delta=1e-5, patience=4,
...
with tf.device('GPU:0'):
    ...
    learning_rate_reduction = ReduceLROnPlateau(
        monitor='loss', patience=1, verbose=1, factor=0.9, min_lr=1e-5)
    ...
    model.compile(loss=custom_loss, optimizer=Adam(
        lr=8e-2, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0))
